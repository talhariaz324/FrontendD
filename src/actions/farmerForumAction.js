...
import {
  ...
  export const createQuestion = (question) => async (dispatch) => {
    try {
      ...
      const { data } = await request.post(`/api/v1/farmer-forum/create-question`, question, config);
      dispatch({
  ...
  export const getAllQuestions = () => async (dispatch) => {
    try {
      ...
      const { data } = await request.get(`/api/v1/farmer-forum/all-questions`);
